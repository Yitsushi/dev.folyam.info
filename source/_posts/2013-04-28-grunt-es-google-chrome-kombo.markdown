...
image: http://dev-folyam-info.storage.googleapis.com/2013-04-28-grunt-es-google-chrome-kombo/gruntjs-google-chrome.png
---

{% img left http://dev-folyam-info.storage.googleapis.com/2013-04-28-grunt-es-google-chrome-kombo/gruntjs-google-chrome.png %}
...
{% img left http://dev-folyam-info.storage.googleapis.com/2013-04-28-grunt-es-google-chrome-kombo/grunt-devtools-no-project-detected.png %}
...
{% img center http://dev-folyam-info.storage.googleapis.com/2013-04-28-grunt-es-google-chrome-kombo/grunt-devtools-task-list.png %}
...
{% img center http://dev-folyam-info.storage.googleapis.com/2013-04-28-grunt-es-google-chrome-kombo/grunt-devtools-run-default-task.png %}
